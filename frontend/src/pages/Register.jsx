...
import { Sparkles, Mail, Lock, User, UserPlus, ArrowRight, CheckCircle2 } from 'lucide-react'
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 px-4 relative overflow-hidden py-12">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-900/25 p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg">Join MindAlchemy and start your transformation journey.</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:text-indigo-700 dark:hover:text-indigo-300 hover:underline transition-colors">
              Sign in
            </Link>
          </p>
        </div>
